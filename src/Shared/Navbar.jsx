...
import logo from "../../public/assets/instagram.svg"
...
const Navbar = () => {
  const {user, logOut} = useContext(AuthContext)
    ...
    return (
        <div className="navbar max-w-screen-2xl fixed z-30 font-deco text-2xl text-white bg-gradient-to-r from-red-600 via-red-700 to-red-800 hover:bg-gradient-to-br focus:ring-4 focus:outline-none  font-medium rounded-lg  px-5 py-2.5 text-center me-2 mb-2 ">
  ...
  !user ?  <li type="button" className="text-white bg-gradient-to-r from-red-700 via-red-600 to-red-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-bold rounded-lg text-lg px-5 py-2.5 text-center me-2 mb-2"><Link to={'/signIn'}>Log In</Link></li> 
          ...
          <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
               <div className="w-8 md:w-12 rounded-full">
                ...
                <ul tabIndex={0} className=" bg-slate-600 mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content rounded-box w-52">
